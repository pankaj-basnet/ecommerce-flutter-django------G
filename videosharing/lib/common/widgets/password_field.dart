...
// import 'package:flutter_riverpod/flutter_riverpod.dart'; // {{mb= riverpod works like provider with same class names}}
...
class PasswordField extends StatelessWidget {
  const PasswordField(
      {Key? key, required this.controller, this.focusNode, this.radius})
      : super(key: key);
      ...
      return Padding(
          ...
          child: TextFormField(
            ...
            decoration: InputDecoration(
              ...
              isDense: true,
              contentPadding: const EdgeInsets.all(6), // isn=

              // hintStyle: appStyle(12, Kolors.kGray, FontWeight.normal), //isn= {{uncomment later sn=}}
              hintStyle: TextStyle(fontSize: 12, 
              color: Kolors.kGray,
              fontWeight: FontWeight.normal), //isn= {{uncomment later sn=}}
